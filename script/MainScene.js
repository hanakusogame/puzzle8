...
var MainScene = /** @class */ (function (_super) {
    ...
    function MainScene(param) {
        ...
        param.assetIds = [
            ...
            "waku", "clear", "waku", "panel",
            "config", "volume", "test", "glyph72", "number_w", "number_b", "number_p",
            "se_start", "se_timeup", "bgm", "se_clear", "se_move"
        ];
        ...
        _this.loaded.add(function () {
            ...
            _this.append(fg);
            //リセットボタン
            var btnReset = new Button_1.Button(_this, ["リセット"], 500, 300, 130);
            if ((typeof window !== "undefined" && window.RPGAtsumaru) || isDebug) {
            ...
            //ランキングボタン
            var btnRanking = new Button_1.Button(_this, ["ランキング"], 500, 240, 130);
            if ((typeof window !== "undefined" && window.RPGAtsumaru) || isDebug) {
            ...
            _this.update.add(function () {
                ...
                if (t <= -1) {
                    ...
                    if (_this.finishEvent() !== undefined) {
                        _this.finishEvent();
                    }
